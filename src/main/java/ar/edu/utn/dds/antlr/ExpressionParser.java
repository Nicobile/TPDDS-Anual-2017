...
public class ExpressionParser {
	...
	public Operando parse(final String expression, List<Indicador> indicadores) {
		...
		/*
		 * By default Antlr4 lexers / parsers have an attached error listener that
		 * prints errors to stderr. I prefer them to throw an exception instead so I
		 * implemented my own error listener which is attached here. I also remove any
