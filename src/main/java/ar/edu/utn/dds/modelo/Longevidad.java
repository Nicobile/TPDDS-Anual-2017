...
List<Empresa> empresas=getEmpresas().stream().filter(unaE->(unaE.getFechaInscripcion().isBefore(diaInicio))|| (unaE.getFechaInscripcion().equals(diaInicio))).collect(Collectors.toList());
listaEmpresas.clear();
